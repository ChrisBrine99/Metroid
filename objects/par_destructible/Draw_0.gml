if (!ENTT_IS_ON_SCREEN) {return;} // Don't draw the block if it isn't visible on the screen.
...
if (ENTT_CAN_DRAW_SELF && sprite_index != NO_SPRITE){
	if (DEST_IS_HIDDEN && tileset != -1 && tiledata != -1){
